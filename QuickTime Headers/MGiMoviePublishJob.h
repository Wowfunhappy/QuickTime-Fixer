...
@class MGAppleScriptPublishOperation, MGExportOperation, NSBlockOperation, NSError, NSString;

@interface MGiMoviePublishJob : MGJob
{
...
+ (id)iMoviePublishJobWithMediaComposition:(id)arg1 exportParameters:(id)arg2;
