...
@class MGAppleScriptPublishOperation, NSError, NSOperation, NSString;

@interface MGMailPublishJob : MGJob
{
    NSOperation *_encodeOperation;
...
+ (id)mailPublishJobWithMediaComposition:(id)arg1 exportParameters:(id)arg2;
