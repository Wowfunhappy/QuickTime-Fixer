...
@class MGExportOperation, MGVimeoAccount, MGVimeoPublishOperation, NSDictionary, NSError, NSString, NSURL;

@interface MGVimeoPublishJob : MGJob
{
    MGExportOperation *_exportOperation;
    MGVimeoPublishOperation *_publishOperation;
    NSString *_name;
...
- (void)reveal;
- (id)operations;
@property(readonly, nonatomic) MGVimeoAccount *account;
- (void)dealloc;
